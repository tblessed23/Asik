...
public class PlayAudioActivity extends AppCompatActivity {
    ...
    // Fields for views
    TextView mEditTitle, mEditState, mAudioTextView;
...
setActionBarTitle("Playing Your Stroy");
    ...
    private void initViews() {
        ...
        mEditTitle = findViewById(R.id.titleDetails);
    ...
    private void populateUI(Story stories) {
        ...
        mEditTitle.setText(stories.getAudiotitle());
